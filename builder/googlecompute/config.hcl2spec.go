...
type FlatConfig struct {
	...
	UnWrappedStartupScript       *bool                      `mapstructure:"unwrapped_startup_script" required:"false" cty:"unwrapped_startup_script" hcl:"unwrapped_startup_script"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"unwrapped_startup_script":        &hcldec.AttrSpec{Name: "unwrapped_startup_script", Type: cty.Bool, Required: false},
